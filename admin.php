...
<html lang="en">
  ...
  <!-- Navbar -->
      <nav class="navbar navbar-expand-lg  bg-dark">
        <div class="container">
        <a class="navbar-brand text-white" href="admin.php"><strong>PETSHOPQU</strong></a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link mr-4" href="daftar_menu.php">DAFTAR STOCK</a>
            </li>
            <li class="nav-item">
        ...
        <div class="row mb-5 mt-5 ">
          <div class="col-md-6 d-flex justify-content-end">
            <div class="card bg-dark text-white border-light">
              <img src="images/background/cing n jing.jpg" class="card-img" alt="Lihat Daftar Menu" height="200">
              <div class="card-img-overlay mt-5 text-center">
               <a href="daftar_menu.php" class="btn btn-primary">LIHAT DAFTAR STOCK</a>
              </div>
            </div>
          </div>
